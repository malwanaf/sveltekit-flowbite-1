<script>
    ...
    let navBtnClass = 'hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg';


    import { Sidebar, SidebarWrapper, SidebarBrand, SidebarItem, SidebarGroup } from 'flowbite-svelte';
    import { ChartPieSolid, GridSolid, MailBoxSolid, UserSolid, ArrowRightToBracketOutline, EditSolid } from 'flowbite-svelte-icons';
    let spanClass = 'flex-1 ms-3 whitespace-nowrap';
  
    let site = {
      name: 'Lightning Detector',
      href: '/',
      img: '../../img/navicon_w.png'
    };

    import { Chart, Card, A, Dropdown, DropdownItem, Popover } from 'flowbite-svelte';
...
<div class="mt-20 pt-16 mx-14">
    <Card class="fixed right-0">
        ...
        <SidebarWrapper>
          <SidebarGroup>
            ...
            <SidebarItem label="Sign Up">
              <svelte:fragment slot="icon">
                <EditSolid class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
              </svelte:fragment>
            </SidebarItem>
          </SidebarGroup>
        </SidebarWrapper>
