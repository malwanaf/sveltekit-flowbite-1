...
<Alert dismissable border color="dark" class="border-2 my-2 w-4/12">
...
<div class="relative bg-gray-50 dark:bg-slate-900">
	<nav
		class="z-0 flex shrink-0 grow-0 justify-around gap-4 border-t border-gray-200 bg-white/50 p-2.5 backdrop-blur-lg dark:border-slate-600/60 dark:bg-slate-800/50 fixed top-2/4 -translate-y-2/4 right-6 min-h-[auto] min-w-[64px] flex-col rounded-lg border"
	>
		<a
			href="#profile"
